            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="border-b border-stroke px-4 pb-2 dark:border-strokedark md:px-6 xl:px-7.5">
                    <div class="flex justify-between items-center gap-x-6">
                        ...
                        <div class="w-1/12 text-center"><span class="font-medium">Value</span></div>
                        <div class="w-2/12 text-center"><span class="font-medium">Value Type</span></div>
                        <div class="w-1/12 text-center"><span class="font-medium">Max Count</span></div>
                            ...
                            <div class="flex justify-between items-center gap-x-6">
                                ...
                                <div class=" w-1/12 text-end">
                                    <div class=" btn-group">
                                        ...
                                        <form method="POST" id="form_{{ $coupon->id }}"
                                            action="{{ route('admin.coupons.destroy', $coupon->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $coupon->id }}" type="button"
