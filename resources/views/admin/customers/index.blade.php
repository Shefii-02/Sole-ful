            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="border-b border-stroke px-4 pb-2 dark:border-strokedark md:px-6 xl:px-7.5">
                    <div class="flex justify-between items-center gap-x-6">
                        <div class="w-1/12 text-left"><span class="small">#Id</span></div>
                        <div class="w-3/12 text-center"><span class="small">Name</span></div>
                        <div class="w-2/12 text-center"><span class="small">Mobile</span></div>
                        <div class="w-2/12 text-center"><span class="small">Email</span></div>
                        <div class="w-2/12 text-center"><span class="small">Number of Orders</span></div>
                        ...
                        @forelse ($users as $key => $user)
                            <div class="flex justify-between items-center gap-x-6">
                                ...
                                <div class="w-2/12 text-center">
                                    <span class="small">{{ $user->mobile }}</span>
                                </div>
                                ...
                                <!-- Grand Total -->
                                <div class="w-2/12 text-center">
                                    <span class="small">{{ $user->orders->count() }}</span>
                                </div>
                
                                <!-- Created At -->
                                <div class="w-2/12 text-center">
                                    <span class="small">{!! dateTimeFormat($user->created_at) !!}</span>
                                </div>
