        ...
        <form action="{{ route('admin.featured-products.update') }}" method="POST">
            ...
            <div class="p-6 col-lg-12">
                    ...
                    @foreach ($products ?? [] as $key => $item)
                        <div class="col-lg-3 mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="featuredProducts[]" type="checkbox" role="switch"
                ...
                <div class="text-center mt-5">
                    <button type="submit" class="btn text-light bg-success">Update Featured Products</button>
                </div>
            </div>
        </form>
    </div>
