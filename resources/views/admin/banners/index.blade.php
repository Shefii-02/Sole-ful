                        ...
                        @forelse ($banners as $key => $banner)
                            <div class="flex justify-between items-center gap-x-6">
                                ...
                                <div class="w-2/12 flex justify-center">
                                    <img src="{{ asset('images/' . $banner->desktop) }}" class="w-50 rounded-5">
                                </div>
                                <div class="w-2/12 flex justify-center">
                                ...
                                <div class="w-2/12 text-center">
                                    <span
                                        ...
                                        {{ date('M d, Y', strtotime($banner->created_at)) }}
                                    </span>
                                </div>
                                <div class="w-2/12 text-center">
                                    <span
                                        class="inline-block text-capitalize rounded px-2.5 py-0.5 text-sm font-medium text-white {{ $banner->status === 0 ? 'bg-danger' : 'bg-success' }}">
                                ...
                                <div class=" w-2/12 text-end">
                                    <div class=" btn-group">
                                        ...
                                        <form method="POST" id="form_{{ $banner->id }}"
                                            action="{{ route('admin.banners.destroy', $banner->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $banner->id }}" type="button"
