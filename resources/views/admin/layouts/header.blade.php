    ...
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <a class="block flex-shrink-0 lg:hidden" href="{{ route('admin.dashboard') }}">
                <img src="{{ asset('/assets/img/logo/logo.png') }}" class="w-15 ms-3" alt="Logo" />
            </a>
        </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#"
                    ...
                    <span class="hidden text-right lg:block">
                        <span class="block text-sm font-medium text-black dark:text-dark">{{ auth()->user()->name }}</span>
                    </span>

                    <span class="h-12 w-12 rounded-full">
                        <img class="rounded-circle object-cover rounded-full ring-2 ring-indigo-300 dark:ring-indigo-500 h-100 " src="/images/default.jpg" alt="User" />
                    </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    <form action="{{ route('logout') }}" id="logout-form" method="POST"> @method('POST') @csrf </form>
