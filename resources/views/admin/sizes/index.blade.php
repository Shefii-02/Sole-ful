            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="border-b border-stroke px-4 pb-2 dark:border-strokedark md:px-6 xl:px-7.5">
                    <div class="flex justify-between items-center gap-x-6">
                        <div class="w-2/12 text-left"><span class="font-medium">#</span></div>
                        <div class="w-2/12 text-center"><span class="font-medium">Name</span></div>
                        <div class="w-2/12 text-center"><span class="font-medium">Code</span></div>
                        <div class="w-2/12 text-center"><span class="font-medium">Order</span></div>
                        ...
                        @forelse ($sizes as $key => $size)
                            <div class="flex justify-between items-center gap-x-6">
                                ...
                                <div class="w-2/12 text-center">
                                    <span class="font-medium">{{ $size->size_value }}</span>
                                </div>
                                <div class="w-2/12 text-center">
                                    <span class="font-medium">{{ $size->size_code }}</span>
                                </div>
                                <div class="w-2/12 text-center">
                                    <span class="font-medium">{{ $size->display_order }}</span>
                                </div>
                                <div class="w-2/12 text-center">
                                    <span
                                        class="font-medium px-2.5 py-0.5 text-sm font-medium inline-block text-capitalize rounded">
                                        {{ date('M d, Y', strtotime($size->created_at)) }}
                                    </span>
                                </div>
                                <div class=" w-2/12 text-end">
                                    <div class=" btn-group">
                                        ...
                                        <form method="POST" id="form_{{ $size->id }}"
                                            action="{{ route('admin.sizes.destroy', $size->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $size->id }}" type="button"
