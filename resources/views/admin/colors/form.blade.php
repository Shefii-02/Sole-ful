    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.colors.index') }}">
                      ...
                      <span class="hover:text-primary">colors</span>
                    </a>
                  </li>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <h2 class="text-title-sm2 font-bold text-black dark:text-black">
                    {{ isset($color) ? 'Edit color' : 'Create a color' }}
                </h2>
            </div>
            ...
            <form enctype="multipart/form-data"
                ...
                <div class="p-6.5 ">
                    ...
                    <div class="mb-2 w-1/2">
                        <label class="block mb-2 text-sm font-medium text-black dark:text-dark">Color Name</label>
                        <input type="text" autocomplete="off" name="color_name" class="form-control" value="{{ old('color_name', $color->color_name ?? '') }}" />
                        @error('color_name')
                    ...
                    <div class="mb-2 w-1/2">
                        <label class="block mb-2 text-sm font-medium text-black dark:text-dark">Color Code</label>
                        <input type="text" autocomplete="off" name="color_code" class="form-control" value="{{ old('color_code', $color->color_code ?? '') }}" />
                        @error('color_code')
                            <span class="fw-bold text-danger">{{ $message }}</span>
                        @enderror
                    </div>
