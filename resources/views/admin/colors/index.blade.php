                    ...
                    <div class="flex flex-col gap-y-4">
                        @forelse ($colors as $key => $color)
                            <div class="flex justify-between items-center gap-x-6">
                                ...
                                <div class="w-2/12 text-center">
                                    <span class="font-medium">{{ $color->color_code }}</span>
                                </div>
                                <div class="w-2/12 text-center">
                                    <span class="font-medium">{{ $color->display_order }}</span>
                                </div>
                                <div class="w-2/12 text-center">
                                    <span
                                        class="font-medium px-2.5 py-0.5 text-sm font-medium inline-block text-capitalize rounded">
                                        {{ date('M d, Y', strtotime($color->created_at)) }}
                                    </span>
                                </div>
                                <div class=" w-2/12 text-end">
                                    <div class=" btn-group">
                                        ...
                                        <form method="POST" id="form_{{ $color->id }}"
                                            action="{{ route('admin.colors.destroy', $color->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $color->id }}" type="button"
