                ...
                <div class="col-lg-12 py-3">
                    <div class="table-back employee-office-table">
                        ...
                        <form action="{{ route('admin.orders.update',$order->id) }}" method="POST">
                            ...
                            <br>
                            <h6>Verified at : {{ dateFormat($order->verified_at) . ' ' . TimeFormat($order->verified_at) }}</h6>
                            @endif
                            <div class="col-lg-12 my-3 d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" {{ $order->verified_at ? '' : 'checked' }} type="radio" name="verified_at" id="notVerified"
                                        value="Not Verified">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" {{ $order->verified_at ? 'checked' : '' }} type="radio" name="verified_at" id="Verified"
                                        value="Verified">
                            ...
                            <div class="mt-3 d-flex gap-3">
                                ...
                                <a href="{{ route('admin.orders.print', $order->invoice_id) }}" target="_new"
                                    class="btn btn-theme button-1 text-white ctm-border-radius p-1 cursor-pointer mr-2">Print
                                    Invoice</a>
                            </div>
