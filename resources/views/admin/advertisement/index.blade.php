                            ...
                            <div class="flex justify-between items-center gap-3">
                                <div class="w-5/12 xl:w-3/12">
                                    <div class="flex items-center gap-4">
                                        <img src="{{ asset('images/' . $adv->image) }}" style="width: 100%">
                                    </div>
                                </div>
                                <div class="w-2/12 xl:w-3/12">
                                    <span class="font-medium">{{ $adv->redirection }}</span>
                                </div>
                                <div class=" w-2/12 2xsm:block md:w-1/12">
                                    <div class="flex justify-between">
                                        ...
                                        <form method="POST" id="form_{{ $adv->id }}"
                                            action="{{ route('admin.advertisement.destroy', $adv->id) }}">@csrf
                                            @method('DELETE')</form>
                                        <button form="form_{{ $adv->id }}" type="button"
                                            onclick="confirmDelete({{ $adv->id }})"
                                            class="mx-auto block hover:text-meta-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
