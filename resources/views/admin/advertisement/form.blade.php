        ...
        <div
            ...
            <nav>
                <ol class="flex flex-wrap items-center gap-2">
                    ...
                    <li>
                        <a class="flex items-center gap-3 font-medium" href="{{ route('admin.advertisement.index') }}">
                            ...
                            <span class="hover:text-primary">Advertisement</span>
                        </a>
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        ...
                        {{ isset($advertisement) ? 'Edit' : 'Create' }}
                    </li>
                </ol>
            </nav>
        </div>
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-5 ">
                        <div class="col-lg-6 mb-3">
                            <label class="mb-3 block text-sm font-medium text-black dark:text-dark">Advertisement
                                Image</label>
                            <div x-data="{
                                image: null,
