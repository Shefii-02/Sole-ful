    ...
    <div style="width: 700px;  margin: 0px auto; background:#FFF; min-height:100vh;position:relative;" >
        <div style="text-align: left;background:#FFF; padding:5px 15px; height:75px; border-bottom:1px solid #f591c1; background:#f591c1;"><!-- Header //-->
            <div style="max-width:50%;clear:none;float:left;" >
                <img src="https://mySoleful.ca/assets/images/email_logo.png"  style="height:auto; margin-top:-3px; max-width:100%;" alt="SWEETIE PIE - Made with Love" />
            </div>
            <div style="float:right;text-align:right;padding:10px 0;white-space:nowrap;position:absolute; right:10px; top:15px; z-index:25;" class="header-right">
                <img src="https://mySoleful.ca/assets/images/ph.png" width="14" height="14"> <a href="tel:+16472453301" style="color:#FFF;font-weight:bold;text-decoration:none;">+1 647-245-3301</a><br/>
                <img src="https://mySoleful.ca/assets/images/em.png" width="14" height="14"> <a href="mailto:contact@Soleful.ca" style="color:#FFF;font-weight:bold;text-decoration:none;">contact@mySoleful.ca</a>
            </div>
        </div><!-- Header //-->
        ...
        <div style="background:#333;height:100px;">
            <div style="padding:5px 10px;color:#FFF;">
                <p style="text-align:center; margin-bottom:5px;"><span style="font-style:italic;">Visit</span>  <a href="https://www.mySoleful.ca" style="color:#FFF;">MySoleful.ca</a> | <span style="font-style:italic;">Follow us on</span>  
                <a href="https://www.facebook.com/mySoleful.ca" style="color:#FFF;"><img src="{{url('assets/images/fb.png')}}" width="14" height="14"></a> <a href="https://www.instagram.com/mySoleful.ca/" style="color:#FFF;"><img src="{{url('assets/images/ig.png')}}"  width="14" height="14"></a> 
                <a href="https://www.tiktok.com/@mySoleful.ca" style="color:#FFF;"><img src="{{url('assets/images/tt.png')}}" width="14" height="14"></a> </p>
