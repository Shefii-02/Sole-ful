                                    ...
                                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                                        ...
                                        <div class="offcanvas-body">
                                            <div class="for-sup">
                                                <div class="f-msp">
                                                    <ul id="header-wr" class="menu">
                                                        <li class="mb-2">
                                                            <a class="dropdown-item font-family-lato"
                                                                href="/">Home</a>
                                                        </li>
                                                        <li class="mb-2">
                                                        ...
                                                        <li class="mb-2 dropdown">
                                                            <a class="dropdown-item dropdown-toggle" href="#"
                                                                id="occasionDropdown" role="button"
                                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                                Occasion
                                                            </a>
                                                            <ul class="dropdown-menu"
                                                                aria-labelledby="occasionDropdown">
                                                                <li>
                                            ...
                                            <div class="social-links position-fixed bottom-0 py-4 bg-white">
                                                <div
                                                    class="footer-social-link-2 flex justify-content-between text-center text-md-end">
                                                    <a href="https://www.youtube.com/@Soleful.Ahdhia" target="_blank">
                                                        <img src="{{ asset('assets/img/icon/Youtube.png') }}"
                                                            class="w-50">
                                                    </a>
                                                    <a href="https://www.instagram.com/Soleful.ahdhia/"
                                                        target="_blank">
                                                        <img src="{{ asset('assets/img/icon/instagram.png') }}"
                                                            class="w-50">
                                                    </a>
                                                    <a href="https://www.facebook.com/Soleful.Ahdhia/"
                                                        target="_blank">
                                                        <img src="{{ asset('assets/img/icon/Facebook.png') }}"
                                                            class="w-50">
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <ul class="d-flex gap-4 align-items-end align-content-end m-1">
                                ...
                                <li class="cursor-pointer d-none d-md-block ">
                                    <a href="{{ route('public.shop') }}"
                                        class="btn btn-theme btn-sm rounded-5 fw-bold">Order
                                        Now</a>
                                </li>
                                ...
                                <li class="me-0 ms-2 wishlist-section " style="display: none">
                                    <a href="#" class="d-inline d-none d-md-block wishlist-btn-view"
                                        data-bs-toggle="offcanvas" data-bs-target="#Wishlist"
                                        aria-controls="Wishlist">
                                        <div class="cart-icon text-center text-theme relative">
                                            <i class="bi bi-heart-fill fs-5"></i>
                                            <span style="top: -15px;"
                                                class="wishlist-count absolute count-rounded">0</span>
                                        </div>
                                    </a>
                                </li>
                                ...
                                @endguest
                                @auth
                                    <li class="last-one d-none d-md-block" x-data="{ open: false }"
