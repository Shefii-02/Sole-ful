$(document).ready(function() {
        ...
        $(`<div class="col-md-6 mb-3">
            <div class="box-div">
                ...
                <div class="row position-relative">
                    ...
                    <div class="col-md-6">
                        <select class="form-control option-type" name="variant_options[`+rand_name+`]">
    ...
    $("body").delegate(".add-option-value","click",function(e){
        ...
        if($(this).prev().val() === '') {
            ...
            console.log(1)
            $(`<a href="#" class="del-option-value"><span class="bi bi-x fs-3></span></a><input type="text" class="form-control option-value mt-2" name="variant_option_values[`+KeyVal+`][]" />`).insertBefore($(this));
        }
    });
    ...
    $(".add-variant").click(function(e){
        ...
        var elem = $(`<div class="row mb-3 position-relative">
            <a href="#" class="del-variant"><span class="bi bi-x fs-3"></span></a>
            <div class="col-md-12">
                <div class="row productVariant" data-id="${rand_name}">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="variants_sku[`+rand_name+`]" value="" class="form-control option-sku pv-sku" placeholder="SKU" />
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="variants_name[`+rand_name+`]" value="" class="form-control option-name pv-name" placeholder="Variant name" />
                    </div>
                    <div class="col-md-1">
                        <input type="text" name="variants_quantity[`+rand_name+`]" value="" class="form-control option-weight" placeholder="Quantit per pack" />
                    </div>
                    <div class="col-md-1">
                        <input type="text" name="variants_weight[`+rand_name+`]" value="" class="form-control option-weight" placeholder="Weight" />
                    </div>
                    <div class="col-md-1">
                        <input type="text" name="variants_price[`+rand_name+`]" value="1.00" class="form-control option-price pv-price" placeholder="Price" />
                    </div>
                    
                    <div class="col-md-3">
                        <div class="variant-platforms">
                            <label class="control-label">Sell at &nbsp; &nbsp; </label>
                            <div class="pretty p-switch p-fill" `+instore_show+`>
                                <input type="checkbox" value="in-store" name="variants_instore[`+rand_name+`]" `+instore_checked+`  class="option-instore" />
                                <div class="state p-success">
                                    <label>In Store</label>
                                </div>
                            </div>
                            <div class="pretty p-switch p-fill" `+online_show+`>
                                <input type="checkbox" value="online" name="variants_online[`+rand_name+`]" `+online_checked+`  class="option-online"  />
                                <div class="state p-success">
                                    <label>Online</label>
                                </div>
                            </div>
                ...
                <div class="box-div">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <img src="/img/noimage.png" style="width:200px;height:auto;" class="mt-3" id="img-`+rand_name+`" />
